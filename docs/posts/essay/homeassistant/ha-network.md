...
1. 开启代理软件的虚拟网卡模式
    ...
    ![image.png](./images/1780829026379-b2xnvz6vvn.png)
...
1. 开启网络共享
    ...
    ![image.png](./images/1780829027746-zk59fmrwdwc.png)


    选择虚拟网卡，鼠标右键点击属性，选择 共享，选择将网络共享到以太网6


    ![image.png](./images/1780829028204-p6n0nt41b6.png)
...
1. 进行 ip 查看和尝试
    ...
    ![MobaXterm_lhcsANSJ9u.png](./images/1780829028757-n68qtixa19k.png)


    查看 ip ， 192.168.137.197，


    ![image.png](./images/1780829029133-j1lyadozxrc.png)
...
1. 通过串口查看是否成功
    ...
    ![MobaXterm_rV0FTJCKqZ.png](./images/1780829029579-8cdcohh67to.png)


打开 应用 可以进行尝试 ，比如下载 OpenThread Border Router 进行尝试，可以下载成功


![image.png](./images/1780829029915-hm3suabhay.png)
...
1. 打开 cmdline.txt ，添加内核 log 指定到串口并设置串口速率，`console=serial0,115200` ,或者复制下面的信息，黏贴为等号前面的内容
...
![chrome_pyB6Asqo1j.png](./images/1780829030348-859f62y4tad.png)


成功信息


![chrome_YWNDEv0Omm.png](./images/1780829030741-2tkgj0r2d3r.png)
...
![chrome_PkY1vTR9Rj.png](./images/1780829031135-ou1zdzq2at.png)
...
![image.png](./images/1780829031569-to0ng0n2lkn.png)
